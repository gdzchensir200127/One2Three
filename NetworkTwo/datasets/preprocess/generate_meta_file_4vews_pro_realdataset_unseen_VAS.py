...
import pickle
import random
dataset_path = "/home/zhang_muxin/data/augmentation_VAS"
meta_dir = "/home/zhang_muxin/data/augmentation_VAS/meta/"
...
def process_category(category:str):
    ...
    train_meta_file = os.path.join(meta_dir,"train_tf_" + category + "_S2M_4views_pro_realdataset_unseen_VAS.txt")
    val_meta_file = os.path.join(meta_dir,"val_tf_" + category + "_S2M_4views_pro_realdataset_unseen_VAS.txt")
    test_meta_file = os.path.join(meta_dir,"test_tf_" + category + "_S2M_4views_pro_realdataset_unseen_VAS.txt")
    file_list = []
...
def process_all():
    ...
    train_meta_file = os.path.join(meta_dir,"train_tf_all_S2M_4views_pro_realdataset_unseen_VAS.txt")
    val_meta_file = os.path.join(meta_dir,"val_tf_all_S2M_4views_pro_realdataset_unseen_VAS.txt")
    test_meta_file = os.path.join(meta_dir,"test_tf_all_S2M_4views_pro_realdataset_unseen_VAS.txt")
    with open(train_meta_file, 'w') as file:
