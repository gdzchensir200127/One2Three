...
def process_category(category:str):
  ...
  file_list.sort()
  file_list = file_list[0:len(file_list)//8]
...
def process_all():
  train_meta_file = os.path.join(meta_dir,"train_tf_all_S2M_4views_pro_small.txt")
  test_meta_file = os.path.join(meta_dir,"test_tf_all_S2M_4views_pro_small.txt")
