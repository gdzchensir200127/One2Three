...
def process_category(category:str):
    ...
    train_meta_file = os.path.join(meta_dir,"train_tf_" + category + "_S2M_4views_pro_realdataset_unseen_new.txt")
    val_meta_file = os.path.join(meta_dir,"val_tf_" + category + "_S2M_4views_pro_realdataset_unseen_new.txt")
    test_meta_file = os.path.join(meta_dir,"test_tf_" + category + "_S2M_4views_pro_realdataset_unseen_new.txt")
    file_list = []
...
def process_all():
    global val_all_list, train_all_list, test_all_list
    val_all_list = shuffle_in_blocks(val_all_list, 4)
    train_all_list = shuffle_in_blocks(train_all_list, 4)
    test_all_list = shuffle_in_blocks(test_all_list, 4)
    train_meta_file = os.path.join(meta_dir,"train_tf_all_S2M_4views_pro_realdataset_unseen_new.txt")
    val_meta_file = os.path.join(meta_dir,"val_tf_all_S2M_4views_pro_realdataset_unseen_new.txt")
    test_meta_file = os.path.join(meta_dir,"test_tf_all_S2M_4views_pro_realdataset_unseen_new.txt")
