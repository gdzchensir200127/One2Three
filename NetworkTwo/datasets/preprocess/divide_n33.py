...
def main():
    # 配置参数
    root_dir = "/home/zhang_muxin/Signal2PC/datasets/data/N21"
    output_meta_dir = "/home/zhang_muxin/Signal2PC/datasets/data"
    val_filename = "val_tf_all_S2M_4views_pro_N21dataset.txt"
    train_filename = "train_tf_all_S2M_4views_pro_N21dataset.txt"
