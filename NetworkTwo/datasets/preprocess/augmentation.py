...
# data_after_remove_background = os.path.join(root_dir, "shapenet_dataset_simulate_signal")
# data_after_augmentation = os.path.join(root_dir, "shapenet_dataset")
data_after_remove_background = os.path.join(root_dir, "beforeaug_2025_10_9")
data_after_augmentation = os.path.join(root_dir, "afteraug_2025_10_9")
target_frame = 2800
min_frame_offset = 0
...
def augmentation(instance_path):
    ...
    origin_signals = []
    for i in range(4):
        signal = loadmat(os.path.join(instance_path,'models', f"{i}.mat"))['data']
