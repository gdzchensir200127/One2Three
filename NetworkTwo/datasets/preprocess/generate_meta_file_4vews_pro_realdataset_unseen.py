...
def process_category(category:str):
    ...
    train_meta_file = os.path.join(meta_dir,"train_tf_" + category + "_S2M_4views_pro_realdataset_unseen.txt")
    val_meta_file = os.path.join(meta_dir,"val_tf_" + category + "_S2M_4views_pro_realdataset_unseen.txt")
    test_meta_file = os.path.join(meta_dir,"test_tf_" + category + "_S2M_4views_pro_realdataset_unseen.txt")
    file_list = []
...
def process_all():
    ...
    train_meta_file = os.path.join(meta_dir,"train_tf_all_S2M_4views_pro_realdataset_unseen.txt")
    val_meta_file = os.path.join(meta_dir,"val_tf_all_S2M_4views_pro_realdataset_unseen.txt")
    test_meta_file = os.path.join(meta_dir,"test_tf_all_S2M_4views_pro_realdataset_unseen.txt")
