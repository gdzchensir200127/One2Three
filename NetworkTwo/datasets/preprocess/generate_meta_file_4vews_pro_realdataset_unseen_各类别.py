...
def process_category(category:str):
    ...
    file_list.sort()
    file_list_1 = file_list[:len(file_list)//2]
    file_list_2 = file_list[len(file_list)//2:]
    temp_list = [file_list_1,file_list_2]
...
if __name__=="__main__":
    list = ["笔记本电脑-all","水杯-all","显示器-all","扳手-all","手机-all","刀具-all","键盘-all","易拉罐-all"]
