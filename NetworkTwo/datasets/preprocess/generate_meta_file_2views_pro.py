...
def process_category(category:str):
  ...
  train_meta_file = os.path.join(meta_dir,"train_tf_" + category + "_S2M_2views_pro.txt")
  test_meta_file = os.path.join(meta_dir,"test_tf_" + category + "_S2M_2views_pro.txt")
  file_list = []
...
def process_all():
  train_meta_file = os.path.join(meta_dir,"train_tf_all_S2M_2views_pro.txt")
  test_meta_file = os.path.join(meta_dir,"test_tf_all_S2M_2views_pro.txt")
  with open(train_meta_file, 'w') as file:
