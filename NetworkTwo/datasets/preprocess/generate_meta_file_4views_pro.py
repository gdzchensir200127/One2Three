...
import pickle
import random
dataset_path = "/home/zhang_muxin/data/shapenet_dataset"
meta_dir = "/home/zhang_muxin/Signal2PC/datasets/data/shapenet_dataset/meta/"
...
def process_category(category:str):
    ...
    train_meta_file = os.path.join(meta_dir,"train_tf_" + category + "_S2M_4views_pro.txt")
    test_meta_file = os.path.join(meta_dir,"test_tf_" + category + "_S2M_4views_pro.txt")
    file_list = []
...
def process_all():
    global all_list
    train_meta_file = os.path.join(meta_dir,"train_tf_all_S2M_4views_pro.txt")
    test_meta_file = os.path.join(meta_dir,"test_tf_all_S2M_4views_pro.txt")
    all_list.sort()
