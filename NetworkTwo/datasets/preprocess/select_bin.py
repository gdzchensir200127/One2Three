...
dataset_path = "/home/zhang_muxin/shapenetS2M_signal"
...
def process_file(dir_path:str):
    for mat_name in mat_names:
        try:
          ...
          output_path = dat_path.replace(dataset_path,output_root).replace('.mat','.json')
          ...
          data = {'start_bin':int(start_bin) ,'end_bin':int(end_bin)}
