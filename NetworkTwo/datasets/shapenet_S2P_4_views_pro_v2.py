...
class ShapeNet_S2P_4_views_pro_v2(BaseDataset):
    """
    ...
    def __init__(self, file_root, file_list_name, mesh_pos, normalization, shapenet_options):
        ...
        self.file_names = [file_name for file_name in self.file_names if file_name.endswith('0.dat')] # only save the */0.dat
